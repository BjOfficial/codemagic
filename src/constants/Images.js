...
export const defaultImage = [
	{
		...
		SewingMachine: {
			...
			Others: {
				id: 'SM5',
				url: require('@assets/images/default_images/OtherDefaultImages/sewingMachine.png'),
			},
		},
		VacuumCleaner: {
			MieleClassic: {
		...
		OxygenConcentrator: {
			...
			Others: {
				id: 'OC11',
				url: require('@assets/images/default_images/OtherDefaultImages/OxygenConcentrators.jpeg'),
			},
		},
		AirFryer: {
			AmericanMicronic: {

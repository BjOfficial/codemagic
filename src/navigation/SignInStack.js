...
import {
  ...
  HelpsupportNav,
  contactNav,
  profmanagmentlistNav,
  AuthNav,
  homepageNav,
  blogdetailsNav,
  nutritionfinalformNav,
  skinfinalformNav,
  loadinganimationNav,
  movementfinalformNav,
  EditPreferencesSkinNav,
  workoutDetailsNav,
  editPreferencesMovementNav,
  DietTypeNav,
  EditPreferencesNutritionNav,
  MealDetailsNav,
  EditPreferencesMealplanNav,
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen
          name={nutritionfinalformNav}
          component={NutritionFinalForm}
        />
        ...
        <Stack.Screen
          name={movementfinalformNav}
          component={MovementFinalForm}
        />
        <Stack.Screen
          name={EditPreferencesSkinNav}
          component={EditPreferencesSkin}
        />
        <Stack.Screen name={workoutDetailsNav} component={WorkoutDetails} />
        <Stack.Screen
          name={editPreferencesMovementNav}
          component={EditPreferencesMovement}
        />
        <Stack.Screen
          name={EditPreferencesNutritionNav}
          component={EditPreferencesNutrition}
        />
        <Stack.Screen name={MealDetailsNav} component={MealDetails} />
        <Stack.Screen
          name={EditPreferencesMealplanNav}
          component={EditPreferencesMealplan}
        />

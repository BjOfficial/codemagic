						...
						{({
							...
							<View>
								<FloatingInput
									...
									value={values.name}
									onChangeText={(data) =>
										changeFieldValue(setFieldValue, 'name', data, touched, setTouched)
									}
								...
								<FloatingInput
									...
									onChangeText={(data) =>
										changeFieldValue(setFieldValue, 'password', data, touched, setTouched)
									}
								...
								<FloatingInput
									...
									rightIcon={
										<TouchableOpacity
											onPress={() => setPasswordConfirmStatus(!passwordConfirmStatus)}>
											<Image
												source={passwordConfirmStatus == true ? eye_close : eye_open}
												style={styles.eyeIcon}
											/>
										</TouchableOpacity>
									}
								...
								<View
									...
									<TouchableOpacity
										...
										<Image
											source={checkboxActive == true ? check_active : check_in_active}
									...
									<View style={{ flex: 0.9, paddingLeft: 5 }}>
										<Text style={styles.acceptenceText}>
											...
											<TouchableHighlight
												...
												<Text style={styles.hyperlinkText}>Terms & Conditions</Text>
											</TouchableHighlight>{' '}

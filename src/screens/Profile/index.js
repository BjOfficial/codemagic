...
import { arrow_down, white_arrow, locationGreen } from '@constants/Images';
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
            <View
              ...
              <View>
                ...
                <Text style={style.headerText}>My Profile</Text>
              </View>
              <TouchableOpacity
        ...
        <View style={styles.uploadedView}>
          <View>
            ...
            <View
              ...
              <View style={{ flex: 0.5 }}>
                <ModalDropdownComp editable_text={false} disabled>
                  <FloatingInput
